...
async function loadAdmin(){
  ...
  app.innerHTML = `
    <div class="grid">
      ...
      <section class="card stat"><div class="label">注册密钥</div><div class="num">${data.stats.invite_key_count || 0}</div><div class="sub">封禁记录 ${data.stats.ban_count || 0} · 用户注册必须持有效密钥</div></section>
    </div>
